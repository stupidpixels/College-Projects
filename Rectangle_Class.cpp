...
double Rectangle::set_height(double Input0){  // Setting the height of the object with the set_height function.
	
  height = Input0;  // Assign height = Input0.
}

double Rectangle::set_width(double Input1){ // Setting the width of the object with the set_width function.
	
  width = Input1; // Assign width = Input1.
}

double Rectangle::perimeter(){  // Setting the perimeter function to be 2 times the width + 2 times the height of the object.

	return 2*width + 2*height; // Return the result.
}

double Rectangle::area(){  // Setting the area function to be the width times the height of the object.
  
	return width * height; // Return the result
}
